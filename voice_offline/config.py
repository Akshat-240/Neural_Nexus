...
AZURE_SPEECH_ENDPOINT = os.getenv("AZURE_SPEECH_ENDPOINT", "https://neuralnexus.cognitiveservices.azure.com/")
AZURE_SPEECH_REGION = os.getenv("AZURE_SPEECH_REGION", "centralindia")

# STT Configuration
STT_ENGINE = os.getenv("STT_ENGINE", "auto")  # auto | azure | whisper | fallback
